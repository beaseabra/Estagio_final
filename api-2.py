...
from framework_object_routes import router as framework_object_router
from framework_metadata_executor_routes import router as framework_metadata_executor_router
...
app = FastAPI(
    title="AiBizCore API",
    description="API do Protótipo AiBizCore v4.3 — Production-Grade",
    version="4.3",
)
...
def health_check():
    return {
        ...
        "routes": {
            ...
            "framework_plan": "/api/framework-plan",
            "framework_object_plan_alias": "/api/framework-object-plan",
            "framework_execute": "/api/framework-execute",
            "framework_execute_alias": "/api/framework-metadata-execute",

    ...
    return {
        ...
        "operations": [
                ...
                "data": [
                    {
                        ...
                        "description": f"{object_name} - Novo",
                        "type": "object",
                        "objectaction": "new",
                    ...
                    },
                    {
                        ...
                        "description": f"{object_name} - Listagem",
                        "type": "view",
                        "objectaction": None,
            ...
            },
            {
                ...
                "cleanup_rule": (
                    "Depois da geração automática, deve ficar apenas a ação 'Novo <Objeto>' "
                    "associada ao objeto base 'Listagem'. Referências duplicadas/erradas devem ser removidas."
                ),
            },
            {
                "step": 10,
...
def plan_framework_metadata_from_blueprint(blueprint: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "execution_order": [
            ...
            "6. Criar/atualizar CSYSObjectLayoutSection.workingdata.",
            "7. Criar CSYSObjectLayoutPermission.",
            "8. Criar CSYSView com serverdata/clientdata.",
            "9. Criar CSYSAction.",
            "10. Criar CSYSObjectAction.",

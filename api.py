...
# Mantém o pipeline atual e acrescenta apenas a rota isolada de preview SQL Server.
...
def provision_db(payload: ProvisionPayload):
    """
    Provisiona a base de dados a partir do schema recebido.

    Nota:
    - Esta rota continua separada do preview.
    - Por defeito usa dry_run=True.
    - A implementação real depende de db_provisioning_agent.py.
    """
    try:
